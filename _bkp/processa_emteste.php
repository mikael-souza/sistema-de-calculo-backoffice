...
if(!empty($_POST["tributoEscolhido_tribut"]) && !empty($_POST["tributoEscolhido_tribut"])){
  ...
  $total_dp = $total;
echo "<div class='col-xl-3 col-lg-6 mb-4'><div class='card'><div class='card-header p-0 position-relative'><div class='position-absolute handle card-icon'><i class='simple-icon-shuffle'></i></div></div><div class='card-body d-flex justify-content-between align-items-center'><h6 class='mb-0'>Total da ContabilidadeR$:".number_format($total_contabilidade, 2, ',','.')."</h6></div></div></div>";
/*var_dump($_POST);*/
?>
