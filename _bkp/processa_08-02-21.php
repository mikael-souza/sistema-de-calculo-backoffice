...
$total_backoffice = $total_contabilidade+$total_tributario+$total_dp;

$total_backo = ($compraeVendaFora == "sim" or $compraeVendaFora == "Sim") ? $total_backoffice+$total_backoffice*0.1 : $total_backoffice ;
